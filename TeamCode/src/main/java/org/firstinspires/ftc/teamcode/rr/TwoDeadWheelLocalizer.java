...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1202.5927023205757; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -927.5220155900281; // x position of the perpendicular encoder (in tick units)
    }
